...
Additional scripts used in the paper are provided in the `repository/` folder, including those used to compute the four feature scores (PLM, disorder, solvent accessibility, conservation).
